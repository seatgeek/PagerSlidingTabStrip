...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public static final int DEFAULT_TAB_BACKGROUND = R.drawable.background_tab;
    ...
    private void setBackgroundOnTab(View v) {
        if (tabBackgroundDrawable != null) {
            Drawable drawable = tabBackgroundDrawable.mutate();
            v.setBackgroundDrawable(drawable);
        } else if (tabBackgroundResId != -1) {
